...
const nav = [
  ...
  },
  {
    ...
    activeColor: 'bg-indigo-500/20 text-indigo-300 border-l-2 border-indigo-400',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    activeColor: 'bg-orange-500/20 text-orange-300 border-l-2 border-orange-400',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 012-2h2a2 2 0 012 2M9 5a2 2 0 002 2h2a2 2 0 002-2m-7 8h6m-6 4h6m-6-8h6" />
      </svg>
    ),
  },
  {
